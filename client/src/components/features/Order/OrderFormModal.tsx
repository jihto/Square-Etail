...
import FormPaymentCash from "../../common/inputs/FormPaymentCash";
import FormPaymentCard from "../../common/inputs/FormPaymentCard";
import FormQrCode from "../../common/inputs/FormQrCode";
