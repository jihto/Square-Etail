    ...
    return (   
        <Container className=" relative overflow-y-auto snap-y snap-mandatory flex flex-col max-h-screen text-center overflow-x-hidden">
            <section className=" snap-start scroll-m-0 h-screen grid-center mx-auto w-full pb-56">
                <motion.img variants={opacityVariants} initial="hidden" animate="visible"  src ="src/assets/images/logo.jpg" className="w-full max-h-[350px] object-contain bg-gradient-to-r from-[#2581fe] to-[#3f8ffe] rounded-xl" /> 
                <motion.p variants={variantsTop()} initial="hidden" animate="visible"  className="uppercase text-2xl md:text-3xl lg:text-5xl font-medium">
                    Wellcome to Square Etail
                </motion.p> 
                <motion.p variants={variantsTop()} initial="hidden" animate="visible" className="text-gray-500 text-base md:text-xl lg:text-2xl w-full lg:w-2/3">
                ...
                <div className="grid gap-x-8 lg:gap-x-20 grid-cols-5 justify-between">
                    <Each 
                        of={ListsIconHomePage}
                        render={(item: {icon: IconType, name: string, animation: any}) =>  
                            <motion.div
                                className="relative w-14 h-14 md:w-20 md:h-20 bg-white shadow-lg rounded-full overflow-hidden"
            ...
            <section ref={ref} className="text-center snap-start scroll-m-0  h-screen"> 
                <motion.p variants={variantsTop()} initial="hidden" animate={isVisible ? "visible" : "hidden"} className="text-2xl md:text-3xl lg:text-5xl font-bold mt-10">Super Combo</motion.p>
                <motion.p variants={variantsBottom()} initial="hidden" animate={isVisible ? "visible" : "hidden"} className="text-gray-500 mb-8 mt-2 text-base md:text-xl lg:text-2xl">Our latest collection, where classic and contemporary  styles converge in perfect harmony</motion.p> 
                <div className="grid-center grid-cols-1 md:grid-cols-3 gap-1 md:gap-5 w-full max-w-[1320px] mx-auto ">
                    <motion.div variants={variantsTop()} initial="hidden" animate={isVisible ? "visible" : "hidden"} className="md:col-span-2 w-full h-[110px] md:h-[350px] bg-black rounded-lg relative inline-block overflow-hidden"> 
                    ...
                    <motion.div variants={variantsRight()} initial="hidden" animate={isVisible ? "visible" : "hidden"} className="w-full h-[110px] md:h-[350px] bg-black rounded-lg relative inline-block overflow-hidden"> 
                    ...
                    <motion.div  variants={variantsLeft()} initial="hidden" animate={isVisible ? "visible" : "hidden"} className="w-full h-[110px] md:h-[350px] bg-black rounded-lg relative inline-block overflow-hidden"> 
                        <div className="absolute w-fit h-fit top-[40%] left-[40%] flex-center z-10 flex-col text-white font-medium">
                            <p className="text-3xl">Pant</p>
                            <p>Chanel</p>
                        </div>
                    ...
                    <motion.div  variants={variantsBottom()} initial="hidden" animate={isVisible ? "visible" : "hidden"}  className="w-full h-[110px] md:h-[350px] bg-black rounded-lg relative inline-block overflow-hidden"> 
                        <div className="absolute w-fit h-fit top-[40%] left-[40%] flex-center z-10 flex-col text-white font-medium">
            ...
            <section ref={ref2} className="pb-20 flex-center flex-col gap-2 md:gap-7 text-black rounded-2xl snap-start scroll-m-0 h-screen">
                <motion.p variants={variantsTop()} initial="hidden"  animate={isVisible2 ? "visible" : "hidden"}  className="font-bold text-2xl md:text-3xl lg:text-5xl mt-10">Bringing you to update fanstastic footwear</motion.p>
                <motion.p variants={variantsBottom()} initial="hidden"  animate={isVisible2 ? "visible" : "hidden"}  className="text-base md:text-xl lg:text-2xl text-gray-500 mb-2 md:mb-16">View all brands of out collection on Footewear, there is another collection. Please check it out bro, seriously!</motion.p>
                <div className="grid-center md:grid-cols-3 w-full gap-5 max-w-[1320px] mx-auto">
                    <Each 
